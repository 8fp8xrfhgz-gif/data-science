...
👉 **Start here:** [Air Pollution Prediction](./air-pollution-prediction) — my primary project, combining regression modeling with a GIS/spatial perspective.

## Projects

### 🌍 [Final Project: Air Pollution Prediction](./air-pollution-prediction)
Regression model predicting NO2 Air Quality Index using EPA monitoring data, testing whether adding geographic location (state) improves prediction accuracy. Compared Linear Regression against Random Forest (R² 0.41 → 0.55), with residual analysis and feature importance to identify the model's real-world limitations.

**Skills:** regression, Random Forest, feature engineering, model evaluation

### 🎯 [Logistic Regression: Customer Churn Prediction](./logistic-regression-churn)
...
Midterm and final exam projects from my GIS programming coursework at National Taiwan University — nearest-station spatial search, SQL-based data analysis, and geospatial visualization (geopandas/folium) of air quality monitoring data. Directly connects to my final project on U.S. EPA pollution prediction.
