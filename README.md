...
Regression model predicting NO2 Air Quality Index using EPA monitoring data, incorporating a Land Use Regression (LUR) perspective from my GIS background — testing whether location-based features improve prediction accuracy.

**Skills:** regression, Random Forest, geospatial feature engineering
